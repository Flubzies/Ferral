...
public class Health : MonoBehaviour
{
	...
	[SerializeField] TimedCallbackEvent _invulnerabilityEvent;
	private bool _invulnerable;

	public Action OnDeath, OnDamaged, OnBecomeInvulnerable, OnEndInvulnerable;
	...
	public void Damage (int damageValue_)
	{
		...
		{
			if (OnBecomeInvulnerable != null) OnBecomeInvulnerable.Invoke ();
			_invulnerable = true;
			_invulnerabilityEvent.TriggerEvent ();
	...
	{
		_invulnerable = false;
		if (OnEndInvulnerable != null) OnEndInvulnerable.Invoke ();
	}
